...
export default function ManagePge() {
    const [openMenu, setOpenMenu] = React.useState<string | null>(null);

    return (
        <SidebarProvider className="grid grid-cols-1 md:grid-cols-[250px_auto] bg-transparent">
            <Sidebar className="border-r bg-primary">
                <SidebarHeader className="px-6 h-[70px] flex justify-center bg-white">
                    <Image src="/logo.svg" width={145} height={40} alt="Picture of the author" />
                </SidebarHeader>
                <SidebarMenu className="py-4 px-3.5 h-[calc(100%-170px)] gap-1.5 overflow-auto bg-white">
                ...
                <SidebarFooter className="px-6 flex h-[100px] justify-center border-t bg-white">
